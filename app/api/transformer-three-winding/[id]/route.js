...
export async function GET(req, { params }) {
  ...
  try {
    const transformer = await TransformersThreeWinding.findById(id);
    if (!transformer) {
...
export async function PUT(req, { params }) {
  ...
  try {
    ...
    const updatedTransformer = await TransformersThreeWinding.findByIdAndUpdate(
      id,
    ...
    const history = new History({
      action: "update",
      dataType: "TransformersThreeWinding",
      recordId: id,
...
export async function DELETE(req, { params }) {
  ...
  try {
    ...
    const deletedTransformer = await TransformersThreeWinding.findByIdAndDelete(id);
